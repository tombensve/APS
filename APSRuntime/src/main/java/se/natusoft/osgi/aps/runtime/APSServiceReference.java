...
/**
 * Provides an implementation of ServiceReference.
 */
public class APSServiceReference implements ServiceReference {
    //
    // Private Members
    //

    private APSBundleContext bundleContext;
    ...
    APSServiceReference( APSBundleContext bundleContext, Dictionary props) {
