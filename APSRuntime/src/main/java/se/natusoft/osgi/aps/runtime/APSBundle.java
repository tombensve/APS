 ...
 */
public class APSBundle implements Bundle {
    //
    // Private Members
    //
     ...
     */
    APSBundle( long id, String symbolicName, ServiceRegistry serviceRegistry ) {
        this.id = id;
    ...
    public void addServiceInstance( Object service ) {
        ...
        this.serviceRegistry.registerService(
                new APSServiceRegistration(
                        service.getClass().getName(),
                        new APSServiceReference( this.bundleContext, properties ),
                        this
                ),
                service,
