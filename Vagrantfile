...
Vagrant.configure(2) do |config|
  ...
  # Note: This config sets up an absolute IP address! This is ofcourse no good
  ...
  config.vm.define "karaf1" do |karaf1|
    karaf1.vm.box = "parallels/ubuntu-14.04"
...
#  config.vm.define "karaf2" do |karaf2|
#    karaf2.vm.box = "parallels/ubuntu-14.04"
#    karaf2.vm.network "public_network", ip: "192.168.1.61"
#    karaf2.vm.provision :shell, path: "vagrant_bootstrap.sh"
#  end
