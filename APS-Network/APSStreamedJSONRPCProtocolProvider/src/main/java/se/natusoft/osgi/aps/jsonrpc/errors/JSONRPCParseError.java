 ...
 */
public class JSONRPCParseError extends JSONRPCError {

    public JSONRPCParseError(String message, Throwable cause) {
        super(ErrorType.PARSE_ERROR, message, cause, null);
    }
    
    public JSONRPCParseError(String message) {
        super(ErrorType.PARSE_ERROR, message, "Failed parsing request!", null);
    }
}
