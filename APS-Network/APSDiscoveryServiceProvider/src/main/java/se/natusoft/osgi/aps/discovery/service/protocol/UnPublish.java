 ...
 */
public class UnPublish implements Protocol {
    //
    // Private Members
    //
    ...
    /**
     * Creates a new UnPublish.
     *
     * @param serviceDescription The description of the service to publish.
     */
    public UnPublish(ServiceDescription serviceDescription) {
     ...
     * Creates a new UnPublish.
     */
    public UnPublish(Message message) {
    ...
    public void write(DataOutputStream dataStream) throws IOException {
        dataStream.writeInt(DiscoveryProtocol.UNPUBLISH);
    ...
    public String toString() {
        return "UnPublish: (From:" + this.fromMember + ") " + this.serviceDescription.getServiceId() + ":" + this.serviceDescription.getVersion();
    }
