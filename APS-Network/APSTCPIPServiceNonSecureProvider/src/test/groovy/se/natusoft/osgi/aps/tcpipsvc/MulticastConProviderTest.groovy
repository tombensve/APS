...
//    private static final boolean testActiveFlag = false
    ...
    public void testSendAndReceive() throws Exception {
        if (testActive) {
            ...
            MulticastReceiver receiver = new MulticastReceiver(config: new ConfigWrapper(name: "testsvc"), logger: logger)
            ...
            receiver.start()
                ...
                MulticastSender sender = new MulticastSender(config: new ConfigWrapper(name: "testclient"))
                sender.start()
