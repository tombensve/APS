    ...
    public void run() {
        ...
        while (isRunning()) {
            try {
                ...
                // We do sometimes get a SocketException on shutdown when the tcpip is closed while this
                // loop still is waiting for receive on the tcpip (SO_TIMEOUT has not yet occurred). There
