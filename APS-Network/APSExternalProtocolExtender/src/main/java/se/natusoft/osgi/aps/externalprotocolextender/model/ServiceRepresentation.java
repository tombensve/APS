...
public class ServiceRepresentation {
    ...
    /**
     * Returns the names of the available methods.
     */
     ...
     *
     * @param method The method to get callable for. This can also be a path for methods annotated with @APSWebService.
     */
