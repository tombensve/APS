...
class VertxClient {
    ...
    @APSService( additionalSearchCriteria = "(vertx-object=Vertx)", timeout = "10 sec" )
    APSServiceTracker<Vertx> vertxTracker

    @APSService( additionalSearchCriteria = "(&(vertx-object=Router)(vertx-router=default))", timeout = "10 sec" )
    APSServiceTracker<Router> routerTracker

    @APSService( additionalSearchCriteria = "(vertx-object=EventBus)", timeout = "10 sec" )
    APSServiceTracker<EventBus> eventBusTracker

    @APSService( additionalSearchCriteria = "(vertx-object=SharedData)", timeout = "10 sec" )
