...
/**
 * This defines the different types of right hand side meny entry types.
 */
public enum MenuEntryType {

    /** The menu entry represents a configuration environment. */
    CONFIG_ENV,

    /** The menu entry represents a configuration. */
    CONFIG
}
