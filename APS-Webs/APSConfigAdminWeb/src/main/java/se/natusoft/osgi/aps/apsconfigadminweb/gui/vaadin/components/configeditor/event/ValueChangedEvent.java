...
public class ValueChangedEvent extends Event {
    ...
    /** The configold value reference representing the actual value. */
     ...
     * @param valueRef The configold value reference representing the actual value.
    ...
    /**
     * Returns the configold value edit model representing the actual value.
     */
