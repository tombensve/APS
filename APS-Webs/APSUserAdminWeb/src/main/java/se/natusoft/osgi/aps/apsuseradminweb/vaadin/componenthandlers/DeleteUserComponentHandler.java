...
/**
 * Component handler for deleting a user.
 */
public class DeleteUserComponentHandler implements ComponentHandler {
    //
    // Private Members
    //
     ...
     *
     * @param userEditor The component to use for deleting a user.
     * @param user The user managed by this component handler.
     */
    public DeleteUserComponentHandler(UserEditor userEditor, UserAdmin user) {
    ...
    public AbstractComponent getComponent() {
        ...
        this.userEditor.setForDelete(true);
