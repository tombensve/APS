...
/**
 * Component handler for editing a role.
 */
public class EditRoleComponentHandler implements ComponentHandler {
    //
    // Private Members
    //
    ...
    /**
     * Creates a new EditRoleComponentHandler.
     *
     * @param roleEditor The editor component to use for editing a role.
     * @param role The role managed by this component handler.
     */
    public EditRoleComponentHandler(RoleEditor roleEditor, RoleAdmin role) {
    ...
    public AbstractComponent getComponent() {
        this.roleEditor.setRole(this.role);
