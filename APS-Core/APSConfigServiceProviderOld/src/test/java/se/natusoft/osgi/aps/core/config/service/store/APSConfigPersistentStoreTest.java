...
//    }
    ...
    public void testGetAvailableConfigurationIds() throws Exception  {
        ...
        assertEquals("se.natusoft.osgi.aps.core.configold.service.MyConfig", configIds.iterator().next());
    ...
    @APSConfigDescription(
            version="1.0",
            configId="se.natusoft.osgi.aps.core.configold.service.MySubConfig",
    ...
    @APSConfigDescription(
            version="1.0",
            configId="se.natusoft.osgi.aps.core.configold.service.MyConfig",
            description="Test of sub configold model."
    )
