...
public class ConfigModelTest extends TestCase {
     ...
     * like modification of one configold value affects another for example.
     *
    ...
    @APSConfigDescription(
            version="1.0",
            configId="aps.configold.test",
            description="Root configold model."
    )
    public static class RootConfig extends APSConfig {

        @APSConfigItemDescription(description="Boolean + configold env specific.",
        ...
        @APSConfigItemDescription(description="List of configold object test 1.")
    ...
    @APSConfigDescription(
            version="1.0",
            configId="simple",
            description="Test of sub configold model."
    )
    ...
    @APSConfigDescription(
            version="1.0",
            configId="complex",
            description="Test of list of configold object."
    )
