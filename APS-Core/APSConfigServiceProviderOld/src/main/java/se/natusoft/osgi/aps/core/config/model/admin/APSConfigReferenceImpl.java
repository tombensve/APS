...
/**
 * This represents an abstract reference to a configold value or a configold object.
 */
public class APSConfigReferenceImpl implements APSConfigReference {
    ...
    /** The configuration environment for the reference. Only needed for configold env specific values. */
     ...
     */
    @Override
    public APSConfigReference __(APSConfigValueEditModel cvem) {
     ...
     */
    @Override
    public APSConfigReference __(APSConfigValueEditModel cvem, int index) {
     ...
     */
    @Override
    public APSConfigReference __(int index) {
        return index(index);
    }
     ...
     */
    @Override
    public APSConfigReference __(APSConfigEnvironment configEnvironment) {
