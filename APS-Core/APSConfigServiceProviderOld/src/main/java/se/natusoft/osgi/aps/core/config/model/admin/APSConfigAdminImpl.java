...
public class APSConfigAdminImpl implements APSConfigAdmin {
     ...
     *
     * @param configModel The configold model of this configuration.
    ...
    /**
     * Returns the value of the configold with the specified key.
     * @param key The key of the configold to get.
     */
    ...
    /**
     * Sets a configold value.
     *
     * @param key The key of the configold value to set.
     * @param value The value to set.
     */
     ...
     *
     * @param key The key of the configold value to remove.
     * @return The value of the removed configold value.
     */
