...
public class APSConfigEditModelImpl<APSConfigSubclass extends APSConfig> extends APSConfigValueEditModelImpl
     ...
     *
     * @param configClass The configold definition class to parse.
     * @param configObjectFactory A factory for APSConfig* objects.
     *
     * @throws APSConfigException On bad configold class.
     */
     ...
     * specific instance that is part of a list of instances of this configold.
     *
     * @param configClass The configClass interface class.
     * @param parent The parent of this configold model. For top level model this should be null.
     * @param configObjectFactory A factory for APSConfig* objects.
     *
    ...
    public APSConfigEditModelImpl(
        ...
        // Update the key with configId and version.
        getKey().configId(this.configId).version(this.version);
    ...
    private void parse(Field field, APSConfigDescription apsConfig, APSConfigItemDescription configItem) throws APSConfigException {
        ...
        // List of normal configold value.
        ...
        // Subclass of APSConfig (sub configold).
        else if (APSConfig.class.isAssignableFrom(type)) {
            if (APSConfig.class.equals(type)) {
                throw new APSConfigException("APSConfig is not a valid configold value in itself! A subclass of APSConfig is needed!");
            }
     ...
     * @param configItem The configold interface method annotation.
     *
     * @return The created APSConfigValueModelImpl.
     *
     * @throws APSConfigException On bad configold configClass interface.
     */
