...
//import se.natusoft.osgi.aps.core.configold.sync.Synchronizer;
...
public class APSConfigServiceActivator implements BundleActivator {
    ...
    /** The APS filesystem service used for storing configold data. */
...
//    private APSServiceTracker<APSNetTimeService> netTimeServiceTracker = null;
    ...
    /** Logger for configold admin service. */
    private APSLogger configAdminLogger = null;

    /** Logger for configold service. */
...
//    private Synchronizer synchronizer = null;
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        this.configAdminLogger.setLoggingFor("aps-configold-service-provider:admin");
        this.configLogger = new APSLogger(System.out);
        this.configLogger.start(context);
        this.configLogger.setLoggingFor("aps-configold-service-provider");
        ...
        // We are doing a delayed start of the configold services since the startup needs to access the filesystem
    ...
    private void setupServices(APSFilesystemService fsService) throws Exception {
        ...
        // Create the different configold data stores.
