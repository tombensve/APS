...
public class APSConfigValueEditModelImpl implements APSConfigValueEditModel {
    ...
    /** The default configold environment when none have been given. */
    ...
    /**
     * true if the value is a boolean type value (based on configold class value annotation).
     *
     ...
     *
     * @param configEnvSpecific The configold env specificness to set.
     */
    ...
    public String getDefaultValue(APSConfigEnvironment configEnv) {
        ...
        // When a configold environment is not specified in the annotation it will be set to "default". This is
        // a fallback for when there is no default value for the current configold environment, but one for "default".
        // That is, if only a default value for "default" is provided then it will apply for any configold environment.
