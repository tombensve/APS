...
public class APSConfigServiceProvider implements APSConfigService, ConfigUpdateListener {
     ...
     * <p>
     * If the version of the configold Class is new (first time registered) and the prevVersion has been provided
     ...
     *
     * @param configClass The configold class to register.
     ...
     *
     * @param configClass The configold Class for the configuration.
     */
    @Override
        ...
        if (this.osgiConfigAdmin != null) {
            ...
            if (configuration != null) {
                try {
                    ...
                    this.logger.error("Failed to delete ConfigurationAdmin created configold!", ioe);
                }
     ...
     *
     * @return An populated configold Class instance.
     *
    ...
    /**
     * Called when the a configold has been updated in the memory store.
     *
     * @param config The updated configold.
     */
    @Override
    public void updated(APSConfigAdmin config) {
        ...
        if (configuration != null) {
            try {
                ...
                this.logger.error("Failed to update ConfigurationAdmin configold!", ioe);
            }
        }
    }
