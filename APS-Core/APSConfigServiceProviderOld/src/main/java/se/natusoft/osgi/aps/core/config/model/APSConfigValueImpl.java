...
public class APSConfigValueImpl implements APSConfigValue, APSConfigRefConsumer {
    ...
    /** Provides the active configold environment. */
    private ConfigEnvironmentProvider configEnvProvider = null;

    /** The reference to the configold value represented by this instance. */
     ...
     * @param configValuesProvider Provides configuration value store.
     * @param configEnvProvider Provides the currently active configuration environment.
     * @param ref The configold reference to use for this instance.
     * @param logger The logger to log to.
     */
    ...
    /**
     * Ensures and returns a reference to the configold value represented by this instance.
     */
     ...
     * Returns the resolved value.
     *
     * @param configEnvironment The configold environment to get the value for.
     */
     ...
     *
     * @param defaultValue The default value to use if no other default value is available.
     * @param configEnvironment The configold environment to get value for.
     *
     * @return A value guaranteed.
     */
     ...
     *
     * @throws APSRuntimeException on no specified date pattern or no valid date in configold.
     */
    @Override
    public Date getDate() {
    ...
    /**
     * Receives a configold value reference. This implements APSConfigRefConsumer.
     *
     * __NOTE__: This is only for providing configold class fields with a reference. It should not be used to set
