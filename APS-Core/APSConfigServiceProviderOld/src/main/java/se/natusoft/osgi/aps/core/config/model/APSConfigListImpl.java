...
public class APSConfigListImpl<APSConfigSubclass extends APSConfig> implements APSConfigList<APSConfigSubclass>, APSConfigRefConsumer {
    ...
    /** Provides the configold value storage. */
     ...
     * @param configEnvironmentProvider Provides the active configold environment.
     * @param configValueStoreProvider Provides the configold value storage.
    ...
    /**
     * Receives a configold value reference.
     *
