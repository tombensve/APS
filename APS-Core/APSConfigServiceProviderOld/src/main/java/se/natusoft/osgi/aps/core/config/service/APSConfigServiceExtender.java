...
public class APSConfigServiceExtender implements BundleListener {
     ...
     *
     * @param configService The internal configold service instance.
    ...
    /**
     * Handles configold registration and injection for bundle configold classes.
     *
    ...
    /**
     * Handles configold deregistration for bundle configold classes.
     *
     * @param bundle
     */
