...
public class APSConfigPersistentStore implements ConfigStoreInfo {
     ...
     *
     * @param fileTool Used to reading and writing configold files.
     * @param envStore Used to get currently active environment.
     * @param logger The logger to log to.
     *
     * @throws APSConfigException On failure to read configold information.
     */
    ...
    /**
     * Returns the configuration with the specified configold id and version.
     *
        ...
        public Configurations() {
            for (String configFileName : APSConfigPersistentStore.this.fileTool.getFileList(getConfigName(null, null), ".properties")) {
                ...
                if (nameParts.length == 3) {
                    ...
                    APSConfigPersistentStore.this.logger.error("Ignoring non valid configold properties file: " + configFileName);
                }
            }
        }
