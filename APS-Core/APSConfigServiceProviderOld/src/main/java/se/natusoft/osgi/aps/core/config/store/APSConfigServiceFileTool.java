 ...
 */
public class APSConfigServiceFileTool {
    //
    // Private Members
    //
     ...
     */
    public APSConfigServiceFileTool(APSFilesystem fs) {
        this.fs = fs;
    }
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException When things go bad.
     */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException When shit happens.
     */
