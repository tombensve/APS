...
public class APSConfigObjectFactory implements ConfigEnvironmentProvider, ConfigValueStoreProvider {
    ...
    /** The currently active configold environment. */
    private ConfigEnvironmentProvider configEnvironment = null;

    /** The actual configold values. Note that this might not have any values at time of usage here! */
     ...
     *
     * @param configEnvironment The currently active configold environment.
     * @param configValueStore The actual configold values.
    ...
    /**
     * Returns the active configold environment.
     */
    @Override
     ...
     *
     * @param configModel The configold model representing this configold list and its keys in teh value store.
     */
