...
public class APSConfigEnvStore implements ConfigEnvironmentProvider {
    ...
    /** The registered listeners for updates to configold env store. */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException on failure to read enviornment configuration.
     */
    public APSConfigEnvStore(APSConfigServiceFileTool fileTool) throws APSConfigException {
     ...
     *
     * @param testConfigEnvs The already defined configold envs to hold. The first will become the active.
     */
    ...
    /**
     * Provides a complete configold env store as a java.util.Properties.
     *
     * This will reset any earlier stored values.
     *
     * @param envProps The configold env properties to provide.
     */
        ...
        if (activeIdProp != null) {
            ...
            if (activeid >= 0 && activeid < noEnvs) {
                ...
                if (activeName == null || activeName.trim().length() == 0) {
                    throw new IllegalStateException("BUG: The configold environment specified as active (" + activeid + ") has no name!");
                }
    ...
    /**
     * Returns the stored configold environments as a java.util.Properties.
     */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException on failure to save environment configuration.
     */
     ...
     *
     * @throws APSConfigException on failure to set active configold environment. Most likely due to save failure.
     */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException on failure to add environment.
     */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException on failure to remove environment.
     */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.configold.service.APSConfigException on failure to do so.
     */
    ...
    /**
     * Classes that want to be notified of a configold update to the memory store implements
     * this.
     */
    public interface ConfigEnvUpdateListener {
         ...
         *
         * @param configEnvStore The configold env store holding the updated value(s).
         */
