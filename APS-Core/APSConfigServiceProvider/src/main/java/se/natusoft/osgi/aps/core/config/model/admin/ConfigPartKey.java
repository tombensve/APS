...
public class ConfigPartKey {
    ...
    /** The config environemnt specificness of the key. */
    ...
    /**
     * Sets the config environment specificness. If not config environment specific then the config environment
     * is cleared.
     *
     * NOTE: This needs to be set before the key is used!
     *
     * @param configEnvSpecific The config environment specificness to set.
     */
