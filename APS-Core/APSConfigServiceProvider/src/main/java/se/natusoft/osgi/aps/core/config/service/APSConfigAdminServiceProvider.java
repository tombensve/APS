...
public class APSConfigAdminServiceProvider implements APSConfigAdminService, APSConfigEnvAdmin, ConfigEnvironmentProvider {
    ...
    /** Provides information about stored config. */
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.config.service.APSConfigException if the specified environment is not among those returned by
    ...
    public void selectActiveConfigEnvironment(APSConfigEnvironment environment) throws APSConfigException {
        ...
        this.logger.info("Active config environment was changed to: '" + environment.getName() + "'!");
    }
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.config.service.APSConfigException on any failure to persist the changes.
     */
    @Override
     ...
     *
     * @throws se.natusoft.osgi.aps.api.core.config.service.APSConfigException on failure to remove.
     */
    @Override
