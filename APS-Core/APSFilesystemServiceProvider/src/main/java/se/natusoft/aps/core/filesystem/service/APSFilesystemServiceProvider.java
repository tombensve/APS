 ...
 *
 */
package se.natusoft.aps.core.filesystem.service;
...
import static se.natusoft.aps.core.APSServiceLocator.service;
...
public class APSFilesystemServiceProvider implements APSFilesystemService {
     ...
     * Our logger.
     */
    private final APSLogService logger = service(APSLogService.class);
    ...
    public APSFilesystemServiceProvider() {
        this.apsFSRoot = getFSRoot();
    }
    ...
    private String getFSRoot() {
        ...
        if (fsRoot == null) {
            ...
            if (userHome != null) {
                ...
                throw new APSConfigException("The '" + APSFilesystemService.CONF_APS_FILESYSTEM_ROOT +
                        "' system property " +
                        "was not found and system property 'user.home' was not found either! So you are pretty" +
                        "much screwed here! You need to provide configuration!");
            }
        }
