 ...
 *
 */
package se.natusoft.osgi.aps.api.core.configold.annotation;
...
public @interface APSConfigDescription {
     ...
     * of the same configold concurrently. You only need to bump the version if you have non backwards
     * compatible changes. Just adding new values to a configuration does not need a new version.
     */
    String version();

    /**
     * Optional previous version. If this is provided the new configold version can be preloaded with values
    ...
    /**
     * A group this configold belongs to. The group can be structured into sub groups with dot '.' notation.
     */
