 ...
 *
 */
package se.natusoft.osgi.aps.api.core.configold.model;

/**
 * This represents a list of a sub-configuration (A configold class extending _APSConfig_, but only referenced by another such class).
 *
