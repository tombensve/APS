 ...
 *
 */
package se.natusoft.osgi.aps.api.core.configold;
 ...
 *
 *         ´@APSConfigDescription(description="my other configold")
 ...
 *
 * * __APSConfigValue__ - One configold value.
 * * __APSConfigValueList__ - List of configold values.
 * * __? extends APSConfig__ - Sub-configold class. Works just like a main configold class which is registered with APSConfigService.
 * * __APSConfigList&lt;? extends APSConfig&gt;__ - List of sub-configold class.
 *
 ...
 *
 *     ´@APSConfigDescription(version=2, description="Web services configold")
 ...
 *      }
 *
 * **Yes**, you can replace any value in a configold class instance. **No**, you should not do that if you want it to work!
 *
 * The reason for this somewhat strange configold API is that this allows for populated instances of these configold classes to be
...
public class APSConfig /*implements ManagedService*/ {
    ...
    /** The event listeners on this configold object. */
    ...
    /**
     * Adds a configold changed event listener to this configold.
     */
    ...
    /**
     * Removes a previously added configold changed event listener from this configold.
     */
     ...
     *
     * @param configId The id of the changed configold.
     */
     ...
     *
     * @param ref The configold value dot notation.
     *
     ...
     * @param nameRef A reference to a value in this configold (see lookup(ref) above). The last part of the
     *                reference must be a field in an APSConfig subclass in an APSConfigList or this will
     *                thrown an exception.
     * @return A list of String names extracted from configold.
     */
    public static List<String> getNamedConfigEntryNames(Class<APSConfig> configClass, String nameRef) {
        ...
        if (managed == null) throw new APSRuntimeException("Bad configold class! No 'public static ManagedConfig' field was found!");
...
//     * **APS additions:**
//     *
//     * This allows for using APS configurations for a standard OSGi service configold.
...
//     * configuration properties will also be registered with the standard OSGi configold
...
//     *
//     * In general the _APSConfigService_ is intended for application wide configold. A configuration
